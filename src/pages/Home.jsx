  ...
  return (
    <div className="relative">
      ...
      <div className="w-full bg-[#191919] flex justify-center">
        <div
          className={`w-full max-w-[1190px] h-[510px] px-6 flex flex-col justify-center items-center md:h-[639px]
                    ...
                    md:bg-[url('/assets/home/tablet/image-header.jpg')] md:bg-[length:770px_728px] md:px-10
                    lg:bg-[url('/assets/home/desktop/image-hero.jpg')] lg:bg-[length:1440px_728px]
                     lg:items-start`}
        >
          <p className="text-sm text-white opacity-50 tracking-widest uppercase text-center mb-4 md:mb-6">
            New Product
          </p>
          <h1 className="text-5xl font-bold text-white tracking-tight uppercase text-center mb-6 md:text-7xl lg:text-left">
            <span>XX99 Mark II </span>
            <br />
            <span>Headphones</span>
          </h1>
          <h2 className="max-w-[349px] text-base font-medium text-white opacity-75 text-center mb-7 md:mb-10 lg:text-left">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="w-full max-w-[1190px] px-6 mb-6 pt-[120px] md:px-10 md:mb-8 lg:mb-12 md:pt-[96px] lg:pt-[120px]">
          <div
