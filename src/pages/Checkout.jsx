...
function Checkout({ cart, setCart }) {
  ...
  return (
    <div className="relative">
      ...
      <div className="w-full h-full flex flex-col items-center pt-6 px-6 bg-lightgray lg:px-10 lg:pt-12">
        <div className="w-full max-w-[1110px]">
          <p
            className="flex items-center gap-2 font-medium text-base text-black opacity-50 pt-4 pb-6 lg:pb-8"
            onClick={() => navigate(-1)}
          >
            <img
