  ...
  return (
    <div className="w-full bg-secondary flex justify-center">
      ...
      >
        ...
        <div
          className={`w-full flex flex-col gap-12 items-center sm:items-start sm:gap-[32px] 
              ...
              <li>
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill="currentColor"
                    fillRule="nonzero"
                    className="cursor-pointer text-white group-hover:text-primary transition-all"
                  />
                </svg>
              </li>
            </a>
              ...
              <li>
                <svg width="24" height="20" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill="currentColor"
                    fillRule="nonzero"
                    className="cursor-pointer text-white hover:text-primary transition-all"
                  />
                </svg>
              </li>
            </a>
              ...
              <li>
                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill="currentColor"
                    fillRule="nonzero"
                    className="cursor-pointer text-white transition-all group-hover:text-primary"
                  />
                </svg>
              </li>
            </a>
