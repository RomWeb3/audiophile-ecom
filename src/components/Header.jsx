  ...
  return (
    <>
      <div className="w-full bg-secondary flex justify-center">
        <div className="w-full max-w-[1110px] flex justify-between items-center py-[32px] px-6 md:px-10 border-b-[1px] border-primary llg:px-0">
          {screenWidth < 768 ? (
            <>
              <img
          ...
          <div className="relative">
            ...
            {cart.length > 0 && (
              <div
                className={`absolute top-[-8px] right-[-8px] w-[16px] h-[16px] bg-primary rounded-full flex items-center
